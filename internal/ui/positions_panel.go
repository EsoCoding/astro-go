	...
	planetTable := widget.NewTable(
		...
		func(i widget.TableCellID, o fyne.CanvasObject) {
			...
			if i.Row == 0 {
				...
				switch i.Col {
				case 0: l.SetText("Planet")
				case 1: l.SetText("Position")
				case 2: l.SetText("House")
				case 3: l.SetText("Dignity")
				case 4: l.SetText("Retro")
				}
				return
			}
			...
			switch i.Col {
			case 0: l.SetText(shortPlanetName(p.Planet))
			case 1: l.SetText(formatZodiacDMS(p.Longitude))
			case 2: l.SetText(fmt.Sprintf("H%d", p.House))
			case 3: l.SetText(string(p.EssentialStatus))
			case 4: l.SetText(retrogradeMarker(p.Retrograde))
			}
		},
	)
	...
	houseTable := widget.NewTable(
		...
		func(i widget.TableCellID, o fyne.CanvasObject) {
			...
			if i.Row == 0 {
				l.TextStyle.Bold = true
				switch i.Col {
				case 0: l.SetText("House")
				case 1: l.SetText("Cusp")
				case 2: l.SetText("Ruler")
				}
				return
			}
			l.TextStyle.Bold = false
			...
			switch i.Col {
			case 0: l.SetText(fmt.Sprintf("%d", h.Number))
			case 1: l.SetText(formatZodiacDMS(h.CuspLongitude))
			case 2: l.SetText(shortPlanetName(h.Ruler))
			}
		},
	)
	...
	aspectTable := widget.NewTable(
		...
		func(i widget.TableCellID, o fyne.CanvasObject) {
			...
			if i.Row == 0 {
				l.TextStyle.Bold = true
				switch i.Col {
				case 0: l.SetText("Inner")
				case 1: l.SetText("Aspect")
				case 2: l.SetText("Outer")
				}
				return
			}
			l.TextStyle.Bold = false
			...
			switch i.Col {
			case 0: l.SetText(shortPlanetName(a.Inner))
			case 1: l.SetText(aspectGlyph(a.Type))
			case 2: l.SetText(shortPlanetName(a.Outer))
			}
		},
	)
